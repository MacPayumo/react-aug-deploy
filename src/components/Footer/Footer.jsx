        ...
        <div className='row'>
          <div className='col-4'>
            <ul className='unstyled-list'>
              ...
              <li className='list-unstyled-list'><a href='#'>Policy</a></li>
              <li className='list-unstyled-list'><a href='#'>Terms and condition</a></li>
            </ul>
          </div>
          <div className='col-3'>
            <ul className='unstyled-list'>
              ...
              <li className='list-unstyled-list'><Link to="categories/jewelry">Jewelry</Link></li>
